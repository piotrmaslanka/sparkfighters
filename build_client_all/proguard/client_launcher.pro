-injars '../../bin/data/SparkFightersLauncher.jar'
-outjars '../../bin/data/SparkFightersLauncher_proguard.jar'

-libraryjars <java.home>/lib/
-libraryjars '../../monitor/libs/'
...
-flattenpackagehierarchy com.sparkfighters.client.launcher
-repackageclasses com.sparkfighters.client.launcher
...
# methods.
-keepclasseswithmembers public class com.sparkfighters.client.launcher.Main {

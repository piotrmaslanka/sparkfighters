-injars '../../bin/Spark Fighters Patcher.jar'
-outjars '../../bin/Spark Fighters Patcher_proguard.jar'


-libraryjars <java.home>/lib/rt.jar
-libraryjars <java.home>/lib/jfxrt.jar
-libraryjars '../../monitor/libs/tools.jar'
...
-flattenpackagehierarchy com.sparkfighters.client.patcher
-repackageclasses com.sparkfighters.client.patcher
...
# methods.
-keepclasseswithmembers public class com.sparkfighters.client.patcher.Main {
    public static void main(java.lang.String[]);
}

# Keep - Library. Keep all public and protected classes, fields, and methods.
-keep public class com.sparkfighters.client.patcher.WebBrowser {
